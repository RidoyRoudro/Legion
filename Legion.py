#!/usr/bin/python3
#-*-coding:utf-8-*-
# Made With ❤️ By Ridoy Roudro [X-Ridoy]
# Thanks For TEAM LEGION all Members
# Legion's Powerful Members-:
# K.H Munna(Founder) 
		Ridoy Roudro(President)
		Rizbi Ahmed(CEO)
		Afifa(Senior Admin)
		Mosharraf(Admin)
		Jubair(ND.Leader)
...
def banner():
    print("""   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 2.0  │  Script By Ridoy Roudro (X-Ridoy)  │\n       /  ^ \/ / // /  ^ \   │   •• github.com/RidoyRoudro ••   │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")
